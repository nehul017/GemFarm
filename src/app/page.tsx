  ...
  return (
    <div className="bg-primary h-screen md:max-w-[375px] md:mx-auto">
      ...
      <div className="h-[calc(100vh-381px)] relative flex items-center">
        ...
        <div className="px-5">
          <div className="absolute inset-0 bg-[linear-gradient(transparent_95%,rgba(255,255,255,0.07)_5%),linear-gradient(90deg,transparent_95%,rgba(255,255,255,0.07)_5%)] bg-[length:40px_40px] opacity-20 pointer-events-none">

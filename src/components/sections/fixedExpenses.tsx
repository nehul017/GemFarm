...
const expenseOptions: OptionType[] = [
    ...
    { value: "admin_business_insurance_annual", label: "ADMIN - Business Insurance (Annual)" },
    { value: "admin_insurance_sales_vehicle_monthly", label: "ADMIN - Insurance - Sales Vehicle (Monthly)" },
    ...
    { value: "infrastructure_electricity", label: "Infrastructure - Electricity" },
    { value: "infrastructure_internet", label: "Infrastructure - Internet" },
    { value: "web_apps_shopify_gsuite_zoom_other", label: "WEB - Apps - Shopify, GSuite, Zoom, Other" },
    { value: "web_crm", label: "WEB - Customer Relations Management (CRM)" },
    { value: "web_website_software_maintenance", label: "WEB - Website & Software Development & Maintenance" },
    { value: "web_payment_gateway", label: "WEB - Payment Gateway" },
    { value: "staffing_salary_general_manager", label: "STAFFING - Salary - General Manager" },
    { value: "staffing_salary_delivery_driver", label: "STAFFING - Salary - Delivery Driver" },
    { value: "staffing_salary_supporting_farm_staff", label: "STAFFING - Salary - Supporting Farm Staff" },
    { value: "staffing_salary_sales_rep", label: "STAFFING - Salary - Sales Rep" },
    { value: "staffing_contracted_marketing_social_media", label: "STAFFING - Contracted - Marketing / Social Media Manager" },
    { value: "staffing_contracted_graphic_packaging", label: "STAFFING - Contracted - Graphic Designer, Packaging & Collateral" },
  ];
...
export default function FixedExpenses() {
  ...
  return (
    <div>
      ...
      <div className="p-5">
        <Button buttonClass="w-full" green text="Next" onClick={() => router.push("/variable-expenses")} />
      </div>
    </div>
  );
}

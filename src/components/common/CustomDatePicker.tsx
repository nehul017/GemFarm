    ...
    <div>
      ...
      {/* <div className={`relative ${error ? "border-red-500 focus:ring-red-500 focus:border-red-500" :""}`}> */}
        <DatePicker
          ...
          className={`h-[50px] !px-3 py-2 border border-[#E6E6E6] bg-[#f9f9f9] text-[#111827] text-base placeholder:text-base rounded-md focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:border-[#36BA7E] w-full ${error ? "border-red-500 focus:ring-red-500 focus:border-red-500" : ""}`} 
